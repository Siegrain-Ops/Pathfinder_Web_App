...
export function Header() {
  ...
  return (
    <>
      {/* ── Mobile header (< sm) — brand only ────────────────────────────── */}
      {/* Secondary nav (⋯) lives in CharacterSheetHeader when inside a char. */}
      <header className="sm:hidden h-12 shrink-0 border-b border-stone-700/80 bg-stone-900 flex items-center px-4">
