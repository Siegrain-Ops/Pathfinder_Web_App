...
const FROM    = process.env.MAIL_FROM    ?? 'Pathfinder App <noreply@example.com>'
...
function shell(body: string): string {
  return `
    <div style="font-family:system-ui,sans-serif;max-width:480px;margin:0 auto;padding:32px 24px;color:#1c1917;background:#fafaf9;">
      <p style="margin:0 0 24px;font-size:22px;font-weight:700;color:#d97706;">⚔ Pathfinder</p>
      ${body}
      <hr style="border:none;border-top:1px solid #e7e5e4;margin:32px 0 16px;" />
      <p style="margin:0;font-size:11px;color:#a8a29e;">
        You received this email because an action was performed on your Pathfinder account.<br />
